...
namespace WebParaMelvin.Controllers
{
    public class Info_generalController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Fecha,Departamento,Posicion,Tipo_de_evaluacion,Nombre,Sexo,Cedula,Fecha_de_nacimiento,Edad,Id_Empleado,Apellido")] Info_general info_general)
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id_Info_General,Empresa,Fecha,Departamento,Posicion,Tipo_de_evaluacion,Nombre,Sexo,Cedula,Fecha_de_nacimiento,Edad,Id_Empleado,Id_Formulario_S_O,Apellido")] Info_general info_general)
        {
            if (ModelState.IsValid)
            {
                var user = Session["User"] as Usuario;
